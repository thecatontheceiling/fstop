...
// DEPRECATED, use pPortal->GetLocalMins()
const Vector vLocalMins( 0.0f, -PORTAL_HALF_WIDTH, -PORTAL_HALF_HEIGHT );
// DEPRECATED, use pPortal->GetLocalMaxs()
...
bool IsPortalOverlappingOtherPortals( const CProp_Portal *pIgnorePortal, const Vector &vOrigin, const QAngle &qAngles, bool bFizzle /*= false*/ )
{
	...
	Vector vPortalOBBMin = vLocalMins + Vector( 1.0f, 1.0f, 1.0f );
	Vector vPortalOBBMax = vLocalMaxs - Vector( 1.0f, 1.0f, 1.0f );
