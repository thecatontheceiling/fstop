...
#define PORTAL_DEFAULT_HALF_WIDTH	32
#define PORTAL_DEFAULT_HALF_HEIGHT	54
...
#define PORTAL_HALF_WIDTH	(float)PORTAL_DEFAULT_HALF_WIDTH	// DEPRECATED
#define PORTAL_HALF_HEIGHT	(float)PORTAL_DEFAULT_HALF_HEIGHT	// DEPRECATED
...
enum PortalStyle
{
	PORTAL_STYLE_RECTANGLE = 0,
	PORTAL_STYLE_PORTALGUN,
