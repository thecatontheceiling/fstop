...
#define PORTAL_HOLE_EDGE_OFFSET 0.1f // portal is extended by this amount on all sides
...
void CPortalSimulator::MoveTo( const Vector &ptCenter, const QAngle &angles, unsigned short iHalfWidth, unsigned short iHalfHeight )
{
	...
	//update geometric data
	{
		...
		m_InternalData.Placement.flHoleHalfWidth = (float)iHalfWidth + PORTAL_HOLE_EDGE_OFFSET;
		m_InternalData.Placement.flHoleHalfHeight = (float)iHalfHeight + PORTAL_HOLE_EDGE_OFFSET;
	}
	...
	//update hole shape - used to detect if an entity is within the portal hole bounds
	{
		...
		fHolePlanes[(2*4) + 3] = m_InternalData.Placement.vUp.Dot( m_InternalData.Placement.ptCenter + (m_InternalData.Placement.vUp * (iHalfHeight * 0.98f)) );
		...
		fHolePlanes[(3*4) + 3] = -m_InternalData.Placement.vUp.Dot( m_InternalData.Placement.ptCenter - (m_InternalData.Placement.vUp * (iHalfHeight * 0.98f)) );
		...
		fHolePlanes[(4*4) + 3] = -m_InternalData.Placement.vRight.Dot( m_InternalData.Placement.ptCenter - (m_InternalData.Placement.vRight * (iHalfWidth * 0.98f)) );
		...
		fHolePlanes[(5*4) + 3] = m_InternalData.Placement.vRight.Dot( m_InternalData.Placement.ptCenter + (m_InternalData.Placement.vRight * (iHalfWidth * 0.98f)) );
...
void CPortalSimulator::CreatePolyhedrons( void )
{
	...
	//(Holy) Wall
	{
		...
		fPlanes[(2*4) + 3] = m_InternalData.Placement.vUp.Dot( m_InternalData.Placement.ptCenter + (m_InternalData.Placement.vUp * m_InternalData.Placement.flHoleHalfHeight) );

		fPlanes[(3*4) + 0] = vDown.x;
		fPlanes[(3*4) + 1] = vDown.y;
		fPlanes[(3*4) + 2] = vDown.z;
		fPlanes[(3*4) + 3] = vDown.Dot( m_InternalData.Placement.ptCenter + (vDown * m_InternalData.Placement.flHoleHalfHeight) );

		fPlanes[(4*4) + 0] = vLeft.x;
		fPlanes[(4*4) + 1] = vLeft.y;
		fPlanes[(4*4) + 2] = vLeft.z;
		fPlanes[(4*4) + 3] = vLeft.Dot( m_InternalData.Placement.ptCenter + (vLeft * m_InternalData.Placement.flHoleHalfWidth) );
		...
		fPlanes[(5*4) + 3] = m_InternalData.Placement.vRight.Dot( m_InternalData.Placement.ptCenter + (m_InternalData.Placement.vRight * m_InternalData.Placement.flHoleHalfWidth) );
		...
		//upper wall
		{
			...
			//fPlanes[(1*4) + 3] = fTubeDepthDist;
			fPlanes[(2*4) + 3] = m_InternalData.Placement.vUp.Dot( m_InternalData.Placement.ptCenter + m_InternalData.Placement.vUp * (m_InternalData.Placement.flHoleHalfHeight + PORTAL_WALL_MIN_THICKNESS) );
			fPlanes[(3*4) + 3] = vDown.Dot( m_InternalData.Placement.ptCenter + m_InternalData.Placement.vUp * m_InternalData.Placement.flHoleHalfHeight );
			fPlanes[(4*4) + 3] = vLeft.Dot( m_InternalData.Placement.ptCenter + vLeft * (m_InternalData.Placement.flHoleHalfWidth + PORTAL_WALL_MIN_THICKNESS) );
			fPlanes[(5*4) + 3] = m_InternalData.Placement.vRight.Dot( m_InternalData.Placement.ptCenter + m_InternalData.Placement.vRight * (m_InternalData.Placement.flHoleHalfWidth + PORTAL_WALL_MIN_THICKNESS) );
			...
			fPlanes[(3*4) + 3] = vDown.Dot( m_InternalData.Placement.ptCenter + m_InternalData.Placement.vUp * (m_InternalData.Placement.flHoleHalfHeight + PORTAL_WALL_MIN_THICKNESS) );
		...
		//lower wall
		{
			//minimal portion that extends into the hole space
			//fPlanes[(1*4) + 3] = fTubeDepthDist;
			fPlanes[(2*4) + 3] = m_InternalData.Placement.vUp.Dot( m_InternalData.Placement.ptCenter + (vDown * m_InternalData.Placement.flHoleHalfHeight) );
			fPlanes[(3*4) + 3] = vDown.Dot( m_InternalData.Placement.ptCenter + vDown * (m_InternalData.Placement.flHoleHalfHeight + PORTAL_WALL_MIN_THICKNESS) );
			fPlanes[(4*4) + 3] = vLeft.Dot( m_InternalData.Placement.ptCenter + vLeft * (m_InternalData.Placement.flHoleHalfWidth + PORTAL_WALL_MIN_THICKNESS) );
			fPlanes[(5*4) + 3] = m_InternalData.Placement.vRight.Dot( m_InternalData.Placement.ptCenter + m_InternalData.Placement.vRight * (m_InternalData.Placement.flHoleHalfWidth + PORTAL_WALL_MIN_THICKNESS) );
			...
			//general hole cut
			//fPlanes[(1*4) + 3] += 2000.0f;
			fPlanes[(2*4) + 3] = m_InternalData.Placement.vUp.Dot( m_InternalData.Placement.ptCenter + (vDown * (m_InternalData.Placement.flHoleHalfHeight + PORTAL_WALL_MIN_THICKNESS)) );
		...
		//left wall
		{
			...
			fPlanes[(3*4) + 3] = vDown.Dot( m_InternalData.Placement.ptCenter + (vDown * m_InternalData.Placement.flHoleHalfHeight) );
			fPlanes[(4*4) + 3] = vLeft.Dot( m_InternalData.Placement.ptCenter + (vLeft * (m_InternalData.Placement.flHoleHalfWidth + PORTAL_WALL_MIN_THICKNESS)) );
			fPlanes[(5*4) + 3] = m_InternalData.Placement.vRight.Dot( m_InternalData.Placement.ptCenter + (vLeft * m_InternalData.Placement.flHoleHalfWidth) );
			...
			fPlanes[(3*4) + 3] = vDown.Dot( m_InternalData.Placement.ptCenter - (m_InternalData.Placement.vUp * (m_InternalData.Placement.flHoleHalfHeight + PORTAL_WALL_MIN_THICKNESS)) );
			fPlanes[(4*4) + 3] = fFarLeftPlaneDistance;
			fPlanes[(5*4) + 3] = m_InternalData.Placement.vRight.Dot( m_InternalData.Placement.ptCenter + (vLeft * (m_InternalData.Placement.flHoleHalfWidth + PORTAL_WALL_MIN_THICKNESS)) );
		...
		//right wall
		{
			...
			fPlanes[(2*4) + 3] = m_InternalData.Placement.vUp.Dot( m_InternalData.Placement.ptCenter + (m_InternalData.Placement.vUp * (m_InternalData.Placement.flHoleHalfHeight)) );
			fPlanes[(3*4) + 3] = vDown.Dot( m_InternalData.Placement.ptCenter + (vDown * (m_InternalData.Placement.flHoleHalfHeight)) );
			fPlanes[(4*4) + 3] = vLeft.Dot( m_InternalData.Placement.ptCenter + m_InternalData.Placement.vRight * m_InternalData.Placement.flHoleHalfWidth );
			fPlanes[(5*4) + 3] = m_InternalData.Placement.vRight.Dot( m_InternalData.Placement.ptCenter + m_InternalData.Placement.vRight * (m_InternalData.Placement.flHoleHalfWidth + PORTAL_WALL_MIN_THICKNESS) );
			...
			fPlanes[(2*4) + 3] = m_InternalData.Placement.vUp.Dot( m_InternalData.Placement.ptCenter + (m_InternalData.Placement.vUp * (m_InternalData.Placement.flHoleHalfHeight + PORTAL_WALL_MIN_THICKNESS)) );
			fPlanes[(3*4) + 3] = vDown.Dot( m_InternalData.Placement.ptCenter + (vDown * (m_InternalData.Placement.flHoleHalfHeight + PORTAL_WALL_MIN_THICKNESS)) );
			fPlanes[(4*4) + 3] = vLeft.Dot( m_InternalData.Placement.ptCenter + m_InternalData.Placement.vRight * (m_InternalData.Placement.flHoleHalfWidth + PORTAL_WALL_MIN_THICKNESS) );
			fPlanes[(5*4) + 3] = fFarRightPlaneDistance;
