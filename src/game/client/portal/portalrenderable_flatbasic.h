...
struct FlatBasicPortalRenderingMaterials_t
{
	...
	CMaterialReference	m_PortalDepthDoubler_Rect;
	CMaterialReference	m_PortalStaticOverlay[2];
	CMaterialReference	m_Portal_Stencil_Hole;
	CMaterialReference	m_Portal_Stencil_Hole_Rect; // rectangular stencil hole
	...
	IMaterialVar		*m_pDepthDoubleViewMatrixVar_Rect;
};
...
public:
	...
	virtual unsigned short GetHalfWidth() const	{ return m_iHalfWidth; }
	virtual unsigned short GetHalfHeight() const	{ return m_iHalfHeight; }

	virtual const bool HasStaticOverlay() const	{ return m_Style == PORTAL_STYLE_PORTALGUN; }
	virtual const bool IsRectangular() const { return m_Style == PORTAL_STYLE_RECTANGLE; }
...
protected:
	...
	unsigned short	m_iHalfWidth;
	unsigned short	m_iHalfHeight;
