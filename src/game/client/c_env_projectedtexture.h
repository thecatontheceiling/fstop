...
private:
	...
	float		m_flShadowSoftness;
	
	bool		m_bUberlight;

	CNetworkArray( float, m_UberlightParams, 11 );
	/*float m_fUberlight_NearEdge;
	float m_fUberlight_FarEdge;
	float m_fUberlight_CutOn;
	float m_fUberlight_CutOff;
	float m_fUberlight_Shearx;
	float m_fUberlight_Sheary;
	float m_fUberlight_Width;
	float m_fUberlight_Wedge;
	float m_fUberlight_Height;
	float m_fUberlight_Hedge;
	float m_fUberlight_Roundness;*/
